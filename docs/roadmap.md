...
### Phase 1: Gate 0 実装固定（進行中）
- [x] SuitSpec / Morphotype の初期契約
- [x] 状態遷移（B->C->D->蒸着->封印）の機械化
- [ ] SuitID/ApprovalID運用ポリシー確定
- [ ] Armory Viewer I/O 契約のドキュメント化
...
2. Armory Viewer連携用のI/O契約を `docs/` に追加
3. Track Aの最初のWear Buildを1回完走
